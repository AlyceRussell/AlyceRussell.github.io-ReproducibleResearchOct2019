...
* Remember, many R-users deploy their code online, which makes learning new code easier (i.e. you can look at the final product and code tandemly to figure out the options needed for your document). [**R-Ladies Global**](rladies.org) GitHub repository can be found here, and you can download other respositories as a reference during your learning journey: [https://github.com/rladies]
...
Twitter: [**@nerdrusty**](www.twitter.com/nerdrusty)

<br/>

R-Ladies Perth: Follow us on our [**Meetup Page**](www.meetup.com/rladies-perth/) or [**Twitter @RLadiesPerth**](www.twitter.com/RLadiesPerth)
